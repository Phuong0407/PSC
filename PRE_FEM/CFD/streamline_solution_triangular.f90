...
! GLOBAL SYSTEM OF EQUATIONS
    subroutine CALC_STIFF_MAT_GLO()
        ...
        do i = 1, GRID%n_Tri_Elem
            ...
            ! if (i == 3 .or. i == 4 .or. i == 6 .or. i == 15 .or. i == 17 .or. i == 18) then
            !     WRITE(*, '(F6.2)', ADVANCE='NO') STIFF_MAT_LOC(:, :)
            ! end if
        end do
    ...
    subroutine CALC_3_CORNER_NODE_GRAD_RECOVERY(CORNER_3_IND)
        ...
        do i = 2, 4
            if (GRID%NODE_CONN(GRID%NODE_CONN(CORNER_3_IND, i), 8) == 7) then
                ...
                print *, "IND_INTERNAL_NODE", IND_INTERNAL_NODE
                INTERNAL_NODE_COUNT = INTERNAL_NODE_COUNT + 1
            end if
        ...
        print *, "IND_FITTING_NODE", IND_FITTING_NODE(:)
