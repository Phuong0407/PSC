...
void DenseSystemSolver::substituteBackwardLU(const Mat& A, const IndArr& ind, VecCol& B) {
    std::size_t matSize = A.size();
...
void DenseSystemSolver::solveDenseMatrixSystem(Mat& A, const VecCol& B, VecCol& Solution) {
    std::size_t matSize = A.size();
