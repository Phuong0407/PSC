...
using IndNode = unsigned int;
using IndElem = unsigned int;
/**
 * @brief ElementFlux stort the flux for each node of the elem
 * @brief ElementFlux[IndElem][0] stores the flux for the first node
 * @brief ElementFlux[IndElem][1] stores the flux for the second node
*/
using ElementFlux = std::array<double, 2>;
using FluxArr = std::vector<ElementFlux>;
